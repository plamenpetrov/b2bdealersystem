...
<div class="content">
    <div class="row">
        <div class="col-lg-12">
            <div class="col-lg-12">
                <h1 style="font-size: 22pt; text-align: center;">{!! trans('labels.create-edit-product') !!}</h1>
            </div>
            ...
            <div class="form-group">
                {!! Form::label('product', trans('labels.name')) !!}
                {!! Form::text('name', null, ['class' => 'form-control input-lg', 'placeholder' => 'Name', 'required' => '', 'data-error' => trans('labels.invalid-name')]) !!}
                <div class="help-block with-errors"></div>
            </div>

            <div class="form-group">
                {!! Form::label('product', trans('labels.group')) !!}
                {!! Form::select('id_product_groups', arrayToSelectOptions($productGroups), null, ['class' => 'form-control input-lg']) !!}
            </div>
