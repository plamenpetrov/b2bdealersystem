...
<script>
    ...
    function addAllProducts()
    {
        ...
        {
            var quantity = $(e).find('input.quantity').val();
            ...
            if (quantity > 0)
            {
                ...
                cart[i].id_product = $(e).find('input.product').val();
                flag = true;
            }
        });
            ...
            <table class="prod_list table table-striped table-condensed" cellspacing="0" cellpadding="3">
                ...
                <tbody class="body-product-rows">
                    ...
                    <tr class="product-rows">
                        ...
                        <td>1</td>
                        <td>
                            <span class="inc btn btn-success glyphicon glyphicon-plus" style="margin: 0 auto;"></span>
                            <input type="number" class="quantity" name="quantity" value="">
                            <span class="dec btn btn-danger glyphicon glyphicon-minus" style="margin: 0 auto;"></span>
